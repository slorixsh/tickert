		...
		cpuStat.usagePercent(function(error, percent, seconds) {
			...
			const embed = new MessageEmbed()
				...
				.addField('<:documents:773950876347793449> General ❯', [
					`> **:card_index: Bot Name: \`${client.user.tag}\`**`,
				...
				.addField('<:documents:773950876347793449> System ❯', [
					`> **<:online:863875781456429087> Uptime: ${parseDur(client.uptime)}**`,
					`> **<:nodejs:863875994725122059> Node.js: \`${process.version}\`**`,
					`> **<:discordjese:863876247033872404> Discord.js: \`v${djsversion}\`**`,
